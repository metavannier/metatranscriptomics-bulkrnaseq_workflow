...
rule cpm_filtering:
  output:
    count_df = report(OUTPUTDIR + "10_cpm/count.txt", caption="../07_Report/count.rst", category="05 Count matrices"),
    output_filter_count = report(OUTPUTDIR + "10_cpm/count_filtered.txt", caption="../07_Report/count_filtered.rst", category="05 Count matrices"),
    cpm = report(OUTPUTDIR + "10_cpm/cpm_filtered.txt", caption="../07_Report/cpm_filtered.rst", category="05 Count matrices")
